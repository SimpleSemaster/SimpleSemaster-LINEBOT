    ...
    function SearchCredits(){
        ...
        return credits.fetchCredits(year,schoolsys).then(data => {  
            if (data == -1){
                ...
                /*agent.add("詳情可上教務處網站查詢：https://acad.ntub.edu.tw/p/412-1004-1718.php?Lang=zh-tw")
                agent.add("另有英語能力及專業證照之畢業門檻，請上以下網站查詢：https://imd.ntub.edu.tw/p/412-1043-1051.php")*/
            }
        })
    }
